...
namespace ApiBiblio.Controllers
{
    ...
    public class AuteursController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NomAuteur,PrenomAuteur")] Auteur auteur)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomAuteur,PrenomAuteur")] Auteur auteur)
        {
            if (id != auteur.Id)
            {
                return NotFound();
